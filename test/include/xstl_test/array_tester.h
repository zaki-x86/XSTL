...
_BEGIN_XSTL_TEST
    ...
    template<typename _Ty, std::size_t _Size>
    void ArrayTester<_Ty, _Size>::test_forward_iteration()
    {
        this->_verify_iter_ok();
    }

    template<typename _Ty, std::size_t _Size>
    void ArrayTester<_Ty, _Size>::test_const_forward_iteration()
    {
        this->_verify_citer_ok();
    }
    
    template<typename _Ty, std::size_t _Size>
    void ArrayTester<_Ty, _Size>::test_reverse_iteration()
    {
        this->_verify_riter_ok();
    }
    
    template<typename _Ty, std::size_t _Size>
    void ArrayTester<_Ty, _Size>::test_const_reverse_iteration()
    {
        this->_verify_criter_ok();
    }

    template<typename _Ty, std::size_t _Size>
    void ArrayTester<_Ty, _Size>::test_access_via_operator()
    {
        this->_verify_access_operator_ok();
    }

    template<typename _Ty, std::size_t _Size>
    void ArrayTester<_Ty, _Size>::test_access_via_at()
    {
        this->_verify_at_ok();
    }

    template<typename _Ty, std::size_t _Size>
    void ArrayTester<_Ty, _Size>::test_generated_c_array()
    {
        this->_verify_data_ok();
    }

    template<typename _Ty, std::size_t _Size>
    void ArrayTester<_Ty, _Size>::test_front_and_back_access()
    {
    ...
    template<typename _Ty, std::size_t _Size>
    void ArrayTester<_Ty, _Size>::test_fill()
    {
        this->_verify_fill_ok();
    }

    template<typename _Ty, std::size_t _Size>
    void ArrayTester<_Ty, _Size>::test_swap()
    {
