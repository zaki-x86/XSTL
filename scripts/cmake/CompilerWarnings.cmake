...
function(set_ci_project_warnings project_name)
   ...
   if(CMAKE_CXX_COMPILER_ID STREQUAL "GNU" AND CMAKE_CXX_COMPILER_VERSION VERSION_LESS_EQUAL 6)
      message(STATUS "Detected GCC version less than 7")
   ...
   elseif((CMAKE_CXX_COMPILER_ID STREQUAL "Clang") AND (CMAKE_CXX_COMPILER_VERSION VERSION_LESS_EQUAL 10))
      message(STATUS "Detected clang version less than 10")
      set(CLANG_CXXFLAGS
         -Wpedantic
         -Wpedantic-errors
         -Wall
      ...
      message(STATUS "Detected GCC version > 6 and Clang version > 10")
