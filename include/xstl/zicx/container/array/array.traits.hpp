...
struct _array_traits {
  ...
  // return a reference
  // TODO change CONSTEXPR20 to CONSTEXPR11
  static CONSTEXPR11 _T& _s_ref(const _CStyle_array& _t, size_t _n) noexcept {
    return const_cast<_T&>(_t[_n]);
  }

  // cast away the constantness of the array
  // return a reference
  static CONSTEXPR11 _T* _s_ptr(const _CStyle_array& _t) noexcept {
